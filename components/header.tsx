...
export const HeroHeader = () => {
    ...
    return (
        <header>
            <nav data-state={menuState && "active"} className="fixed z-20 w-full pt-2 border-b border-dashed bg-white backdrop-blur dark:bg-zinc-950/50 lg:dark:bg-transparent">
                <div
                    className={cn(
