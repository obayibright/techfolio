            ...
            <div className="mx-auto grid max-w-5xl border md:grid-cols-2">
                <div>
                    <div className="p-6 sm:p-12">
                        ...
                        <p className="mt-8 text-2xl font-semibold">Get served in real time from any corner of the world.</p>
                    </div>

                    <div aria-hidden className="relative">
                        <div className="absolute inset-0 z-10 m-auto size-fit">
                            <div className="rounded-lg bg-background z-10 dark:bg-muted relative flex size-fit w-fit items-center gap-2 border px-3 py-1 text-xs font-medium shadow-md shadow-zinc-950/5">
                                <span className="text-lg">🇳🇬</span> All the Way from Nigeria!
                            </div>
                ...
                <div className="overflow-hidden border-t bg-zinc-50 p-6 sm:p-12 md:border-0 md:border-l dark:bg-transparent">
                    <div className="relative z-10">
                        ...
                        <p className="my-8 text-2xl font-semibold">It's as Simple as sending a Message.</p>
                    </div>
                    <div aria-hidden className="flex flex-col gap-8">
                        <div>
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-muted-foreground text-xs">{new Date().toLocaleDateString('en-US', { weekday: 'short', day: '2-digit', month: 'short' })}</span>
                            </div>
                            <div className="rounded-lg bg-background mt-1.5 w-3/5 border p-3 text-xs">Hey, I want you to build an App.</div>
                        </div>

                        <div>
                            <div className="rounded-lg mb-1 ml-auto w-3/5 bg-blue-600 p-3 text-xs text-white">Thank you for reaching BriteWare. Tell us the kind of App you want to build.</div>
